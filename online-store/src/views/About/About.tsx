                    ...
                    <div className="bg-gradient-to-br from-blue-100 to-green-200 rounded-3xl shadow-2xl p-10 border border-gray-300 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1">
                        ...
                        <div className="space-y-8 text-start">
                            ...
                            <div className="flex items-start space-x-6 p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200 hover:bg-white/80 transition-all duration-300 shadow-lg">
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-gray-800 mb-2">Адрес</h4>
                            ...
                            <div className="flex items-start space-x-6 p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200 hover:bg-white/80 transition-all duration-300 shadow-lg">
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-gray-800 mb-2">Контакти</h4>
                            ...
                            <div className="flex items-start space-x-6 p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200 hover:bg-white/80 transition-all duration-300 shadow-lg">
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-gray-800 mb-2">Работно време</h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                                <div className="flex items-center justify-center md:justify-start">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-semibold text-gray-800">Работни дни</p>
                                ...
                                <div className="flex items-center justify-center">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-semibold text-gray-800">Паркиране</p>
                                ...
                                <div className="flex items-center justify-center md:justify-end">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-semibold text-gray-800">Контакт</p>
                                        <p className="text-sm text-gray-600">24/7 поддръжка</p>
                                    </div>
                                </div>
                            </div>
                        </div>
