            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-center md:justify-start group">
                                <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                </div>
                                <div>
                                    <p className="text-black hover:text-gray-700 transition-colors">+359 882 042 698</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-center md:justify-start group">
                                ...
                                <div>
                                    <p className="text-black hover:text-gray-700 transition-colors">albayrak.ood@gmail.com</p>
                                </div>
                            </div>
                    ...
                    <div className="text-center md:text-left">
                        ...
                        {/* Working Hours */}
                        <div className="bg-green-100/70 backdrop-blur-sm rounded-2xl p-6 border border-black">
